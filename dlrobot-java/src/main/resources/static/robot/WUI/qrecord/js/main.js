...
//  Embedding flash object ---------------------------------------------------------------------------------------------
  ...
  var appWidth = 24;
  var appHeight = 24;
  var flashvars = {'upload_image': 'WUI/qrecord/images/upload.png'};
  var params = {};
  var attributes = {'id': "recorderApp", 'name': "recorderApp"};
  swfobject.embedSWF("WUI/qrecord//recorder.swf", "flashcontent", appWidth, appHeight, "11.0.0", "", flashvars, params, attributes);

//  Handling FWR events ------------------------------------------------------------------------------------------------

  window.fwr_event_handler = function fwr_event_handler() {
    $('#status').text("最后的录音事件：" + arguments[0]);
    var name, $controls;
    switch (arguments[0]) {
      case "ready":
        ...
        $('.save_button').css({'width': '0px', 'height': '0px'});
        break;
